...
const lawyerAssignmentRoutes = require("./Routes/lawyerAssignmentNew");
...
const caseLawyerAssignmentRoutes = require("./Routes/caseLawyerAssignmentRoutes");
const caseCompletionRoutes = require("./Routes/caseCompletionRoutes");
...
app.use("/auth", unverifiedAuthRoutes);
...
app.use("/api/case-lawyer-assignment", caseLawyerAssignmentRoutes);
app.use("/api/case-completion", caseCompletionRoutes);
